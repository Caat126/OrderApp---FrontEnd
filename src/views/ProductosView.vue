<template>
    ...
    <div class="container">
        ...
        <div class="card text-white shadow mt-3">
                        ...
                        <div class="col-8">
                            <div class="card-body">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-4">
                                        <button @click="agregarCarrito(item)" class="btn btn-danger btn-sm">Buy</button>
                                    </div>
                                </div>
                            </div>
                        </div>
        ...
        <div class="col-12 text-center mb-3">
                <button @click="cargarMas()" class="btn btn-light mt-5 mb-5">Cargas Más</button>
            </div>

        <div v-if="carrito.length" class="floating">
...
onMounted(() => {
    ...
    //limpiar el local storage carrito
...
const cargarDatos = async () => {
    try {
        ...
        siguienteUrl.value = data.data.next_page_url;
...
const cargarMas = async () => {
    ...
    try {
        ...
        productos.value.push(...data.data.data);
        siguienteUrl.value = data.data.next_page_url;
    } catch (error) {
        console.log(error)
    }
